...
public class AlternateServerAdapter extends ArrayAdapter<AlternateServer> implements Filterable {
	...
	public AlternateServerAdapter(Context context, int itemTemplateId, List<AlternateServer> alternateServer, ServerTapListener tappedCallback) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		urlTxt.setText(alternateServer.url.toString());
